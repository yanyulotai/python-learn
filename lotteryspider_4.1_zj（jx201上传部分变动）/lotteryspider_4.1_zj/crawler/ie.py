...
class StartCrawler(object):
    ...
    def get_DaiBiaoXinXiData(self):
		...
		#2. 点击销售代表
        xpath_DaiBiaoXinXi_data="/html/body[@class='imgbody']/div[@class='leftbox']/div[@class='menubox']/ul[@id='content1']/li[@sizset='2']/a[@menuId='31120204']"
    ...
    def get_MenDianXinXiData(self):
        ...
        #2. 点击门店
        xpath_MenDianXinXi_data="/html/body[@class='imgbody']/div[@class='leftbox']/div[@class='menubox']/ul[@id='content1']/li[@sizset='3']/a[@menuId='31120205']"
