...
class JX201Table(Table):
	...
	@property
	def insert_sql(self):
		return "INSERT INTO SD_T_PHONE_LOTTERY_TICKET_ALL (SITE_CODE, SITE_NAME, SPORTS_LOTTERY_CODE, SPORTS_LOTTERY_NAME, ACTIVE_NUMBER, ACTIVE_MONEY, SURE_NUMBER, SURE_MONEY, DUIJIANG_NUMBER, DUIJIANG_MONEY, MANAGE_DATE) VALUES "
...
class B402Table(Table):
	...
	@property
	def insert_sql(self):
		return "INSERT INTO SD_T_LOTTERY_TICKET_DUIJIANG (CITY_CODE, CITY_NAME, CONFIRM_PACKAGE, CONFIRM_MONEY , CONFIRM_PROPORTION , ACTIVE_PACKAGE, ACTIVE_MONEY , ACTIVE_PROPORTION , DUIJIANG_NUMBER , DUIJIANG_MONEY , DUIJIANG_PROPORTION, MANAGE_DATE) VALUES "
...
class A205Table(Table):
	...
	@property
	def insert_sql(self):
		return "INSERT INTO SD_T_PROVINCE_STOCK (FACE_VALUE, GAME_CODE, GAME_NAME, II_JIANGZU, II_CASE, II_PACKAGE, II_MONEY, INBOUND_JIANGZU, INBOUND_CASE, INBOUND_PACKAGE, INBOUND_MONEY, OUTBOUND_JIANGZU, OUTBOUND_CASE, OUTBOUND_PACKAGE, OUTBOUND_MONEY, EI_JIANGZU, EI_CASE, EI_PACKAGE, EI_MONEY, MANAGE_DATE) VALUES "
...
class Q102SrTable(Table):
	...
	@property
	def insert_sql(self):
		return "INSERT INTO SD_T_SR_DUIJIANG (PROVINCE_CODE, PROVINCE_NAME, CITY_CODE, CITY_NAME, COUNTRY_CODE, COUNTRY_NAME, ORGANIZATION_TYPE, ORGANIZATION_CODE, ORGANIZATION_NAME, CLAIM_DATE, GAME_CODE, GAME_NAME, TERMINAL_CODE, FACE_VALUE, PACKAGE_NUMBER, TICKET_NUMBER, PRIZE_CLASS, PRIZE_MONEY, STORE_CODE, ACTIVE_TIME, PACKAGE_STATE, MANAGE_DATE) VALUES "
...
class Q102CenterTable(Table):
	...
	@property
	def insert_sql(self):
		return "INSERT INTO SD_T_CENTER_DUIJIANG (PROVINCE_CODE, PROVINCE_NAME, CITY_CODE, CITY_NAME, COUNTRY_CODE, COUNTRY_NAME, ORGANIZATION_TYPE, ORGANIZATION_CODE, ORGANIZATION_NAME, CLAIM_DATE, GAME_CODE, GAME_NAME, TERMINAL_CODE, FACE_VALUE, PACKAGE_NUMBER, TICKET_NUMBER, PRIZE_CLASS, PRIZE_MONEY, STORE_CODE, ACTIVE_TIME, PACKAGE_STATE, MANAGE_DATE) VALUES "
...
class Q102CclientTable(Table):
	...
	@property
	def insert_sql(self):
		return "INSERT INTO SD_T_CCLIENT_DUIJIANG (PROVINCE_CODE, PROVINCE_NAME, CITY_CODE, CITY_NAME, COUNTRY_CODE, COUNTRY_NAME, ORGANIZATION_TYPE, ORGANIZATION_CODE, ORGANIZATION_NAME, CLAIM_DATE, GAME_CODE, GAME_NAME, TERMINAL_CODE, FACE_VALUE, PACKAGE_NUMBER, TICKET_NUMBER, PRIZE_CLASS, PRIZE_MONEY, STORE_CODE, ACTIVE_TIME, PACKAGE_STATE, MANAGE_DATE) VALUES "
...
class AllotDataTable(Table):
	...
	@property
	def insert_sql(self):
		return "INSERT INTO SD_T_BIG_CITY_ALLOT (ALLOT_NUMBER, OUTBOUND_WAREHOUSE, INBOUND_WAREHOUSE, GAME_CODE, GAME_NAME, ALLOT_CASE_NUMBER, ALLOT_SCATTERED_PACKAGE, ALLOT_TOTAL_PACKAGE, GAME_FACE_VALUE, ALLOT_TOTAL_MONEY, MANAGE_DATE) VALUES "
...
class BigCustomerTable():
	...
	@property
	def insert_sql(self):
		return "INSERT INTO SD_T_BIGCUSTOMER (CODE, NAME, SEND_PATTERN, TYPE, REGION_CODE, REGION_NAME, LINKMAN, PHONE, ADDRESS, EMS_CODE, STATES, MANAGE_DATE) VALUES "
